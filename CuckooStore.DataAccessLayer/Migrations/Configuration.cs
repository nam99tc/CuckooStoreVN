namespace CuckooStore.DataAccessLayer.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CuckooStore.DataAccessLayer.CuckooDBcontext>
    {
        ...
        protected override void Seed(CuckooStore.DataAccessLayer.CuckooDBcontext context)
        {
